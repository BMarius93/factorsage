...
owns Redis lookup, canonical-horizon reconciliation, FMP loading, or derived-technical
implementations. Both read requested projections from the same full-stock yearly Redis
representation after one stock-level hydration lock establishes READY.

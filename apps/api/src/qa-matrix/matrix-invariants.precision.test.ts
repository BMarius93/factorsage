...
function baseline(overrides: Partial<RunEvidence> = {}): RunEvidence {
  return {
    ...
    summary: {
      ...
      portfolioReturnPercent: "0.00000000",
      benchmarkReturnPercent: null,
      alphaPercent: null,
      portfolioCagrPercent: null,
      maxDrawdownPercent: "0.00000000",
      benchmarkMaxDrawdownPercent: null,
    ...
    positions: [
      {
        ...
        unrealizedPnl: "500.000000",
        unrealizedPnlPercent: "0.00000000",
        allocationPercent: "0.00000000",
      },
    ],

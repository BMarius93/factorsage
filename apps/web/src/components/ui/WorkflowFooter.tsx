...
/**
 * The shared create/edit action footer.
 *
 * Every workflow ends the same way, in the same place, in the same order — and on a phone
 * the bar sticks above the bottom navigation so a long form's submit is always reachable.
 * Features own the labels and the behaviour; this owns where they sit.
 */

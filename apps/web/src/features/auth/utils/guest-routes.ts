 ...
 * a visitor sees. Everything else in the application needs a session. A detail route is readable
 * because it may name a built-in; the API still answers `404` for anybody else's content.
 */
